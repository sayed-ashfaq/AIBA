...
analytics_agent, and visualizer subagents (knowledge_agent joins once it's built), the orchestrator's
...
from app.agents.subagents.analytics_agent.subagent import analytics_agent
...
agent = create_deep_agent(
    ...
    subagents=[sql_agent, analytics_agent, visualizer],
    middleware=[
        TodoListMiddleware(),
